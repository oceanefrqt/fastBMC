...
import stages_fastBMC_several_metrics as st
...
def main():
    ...
    acc, auc, f1 = st.stage_2(df, k_opt, thresh, inputs.outdir, inputs.nbcpus, funct, strat)
    ...
    print(f"{total_cpu_time} , {auc}, {acc}, {f1}")
